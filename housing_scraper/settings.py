"""
Django settings for housing_scraper project.
...
SECRET_KEY = "django-insecure-bgj-d_8#c9p6i#7rapy9*ak2bgb#=)c$1m1^a=6cg(b+!3)p0@"
...
ROOT_URLCONF = "housing_scraper.urls"
